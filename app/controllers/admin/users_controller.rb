=begin
      ...
      Per costruire un name-spaced controller, abbiamo in effetti eseguito:
      
       rails g controller admin/users 
      
      Utilizzando il separatore / indichiamo a Rails di generare un name-spaced controller.       
...
class Admin::UsersController < Admin::BaseController
 # ==> Spostato in BaseController before_filter :authorize_admin! # Metodo definito in application_controller.rb
